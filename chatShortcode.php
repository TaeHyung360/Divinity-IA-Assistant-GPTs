        ...
        <div class="container-main">
            <div class="divinity-ia-products-column">
                ...
                <div class="divinity-ia-btn-carrito-container">
                    <button id="add-to-cart-btn">Añade todos los productos al carrito</button>
                </div>
            </div>
            <div class="divinity-ia-chat-container">
                <div class="divinity-ia-chat-messages">
                <div class="respuesta-ra"><span class="icono-ra"></span><span class="nombre-ra">RA:</span><br>¡Hola! ¿Cómo puedo ayudarte? Si necesitas asesoramiento para configurar un PC o tienes alguna consulta específica sobre componentes de ordenador, estoy aquí para ayudarte.<br><br><br></div>
                </div>
